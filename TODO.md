...
- Calendrier diocésain 2026-2027 (`inc/import/data-calendrier.php` vide) : `CALENDRIER_DIOCESAIN_2027.pdf` disponible dans `documents/` mais pas encore transcrit (hors périmètre des prompts reçus jusqu'ici) — voir `BUGS_AND_ROADMAP.md`
...
- Fiches `paroisse` (CPT vide) : nécessaire pour que les relations `evenement_paroisse`/`paroisse` du calendrier (une fois importé) se rattachent correctement plutôt qu'en texte libre
