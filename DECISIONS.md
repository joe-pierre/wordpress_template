...
**Statut :** 🔵 Choix assumé — structure des 33 entités en place et testée ; `responsable`/`membres`/`aumônier` réels bloqués tant que `NOMINATIONS_SERVICES_COMMISSIONS_AUMONERIES_2027.pdf` n'est pas fourni
