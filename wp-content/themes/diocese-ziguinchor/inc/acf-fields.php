			...
			'fields'   => array(
				array(
					...
					'sub_fields'   => array(
						...
						array(
							'key'          => 'field_dz_front_hero_slide_source_id',
							'label'        => __( 'Identifiant source (import)', 'diocese-ziguinchor' ),
							'name'         => 'dz_front_hero_slide_source_id',
							'type'         => 'text',
							'instructions' => __( "Réservé à l'outil d'import (Réglages > Import contenu diocèse) : sert à ne jamais réimporter deux fois le même slide. Laisser vide pour un slide ajouté manuellement.", 'diocese-ziguinchor' ),
							'required'     => 0,
						),
					),
				),
